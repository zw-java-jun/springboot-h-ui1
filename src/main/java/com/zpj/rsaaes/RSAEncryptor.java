...
public class RSAEncryptor {
    ...
    public static String rsaEncry(String rsaBase64){

        String privateKeyPath = "/Users/apple/Desktop/rsa_public_key.pem";        // replace your public key path here
        String publicKeyPath = "/Users/apple/Desktop/pkcs8_private_key.pem";     // replace your private path here
        RSAEncryptor rsaEncryptor = null;
        try {
            rsaEncryptor = new RSAEncryptor(privateKeyPath, publicKeyPath);
        } catch (Exception e) {
            e.printStackTrace();
        }
