...
//2、设置数据源
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/bootui?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
...
//3、包的配置
        ...
        pc.setModuleName("role"); // 设置模块名
        pc.setParent("com.zpj"); // 这个模块在那个位置生成
